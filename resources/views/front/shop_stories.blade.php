...
<section id="shopStories" data-feed="{{ route('shop-stories.feed') }}" data-show-list="{{ ($showStoryList ?? true) ? '1' : '0' }}" hidden><h2>ستوريات المحلات</h2><div id="shopStoriesList"></div></section>
