...
<main class="cosmetics-shell">
    <div class="cosmetics-hero">
        ...
        <header class="beauty-brand">
            ...
            <p class="brand-description">{{ $shop->description ?: __('عطور مختارة ومنتجات عناية وجمال لكل تفاصيلك.') }}</p><span class="brand-status">{{ __('متاح للطلبات') }}</span>
    ...
    <section class="catalog-panel" id="beautyCatalog"><header class="catalog-heading"><div><h1>{{ __('اكتشفي الجمال بطريقتك') }}</h1><p>{{ __('اختاري القسم ثم أضيفي ما يعجبك إلى سلة الطلب.') }}</p></div><i class="ti ti-sparkles" style="font-size:33px;color:var(--gold)"></i></header>
