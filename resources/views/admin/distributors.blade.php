...
<head>
    <title>الموزعون — هيلني شوب</title>
    <meta charset="UTF-8">
...
<body>
 ...
 @include('admin.includes.sidebar')
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-title">الموزعون</div>
            ...
            <div class="content">
                ...
                <div class="page-header-row">
                    ...
                    <a href="#" class="btn-red"><i class="ti ti-plus" aria-hidden="true"></i> موزع جديد</a>
                </div>
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-label">إجمالي الموزعين</div>
                        <div class="stat-val">12</div><i class="ti ti-truck stat-icon" aria-hidden="true"></i>
                    </div>
                    <div class="stat-card" style="--accent:#27AE60">
                        <div class="stat-label">نشط</div>
                        <div class="stat-val" style="color:#27AE60">10</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-label">غير نشط</div>
                        <div class="stat-val" style="color:var(--red-light)">2</div>
                    </div>
                ...
                <div class="card">
                    <div class="card-hd">
                        ...
                        <div class="input-wrap"><i class="ti ti-search search-icon" aria-hidden="true"></i><input
                                class="search-inp" id="distSearch" placeholder="بحث..."></div>
                    </div>
                    <table id="distTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="color:var(--text);font-weight:500">موزع الشمال</td>
                                <td dir="ltr">059-700-8000</td>
                                <td dir="ltr">059-700-8000</td>
                                <td>جنين</td>
                                <td>شارع القدس</td>
                                <td>صيدلية الشفاء</td>
    ...
    <script>
        document.getElementById('distSearch').addEventListener('input', function() {
            const q = this.value.toLowerCase();
            document.querySelectorAll('#distTable tbody tr').forEach(r => {
