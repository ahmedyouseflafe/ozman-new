...
<head>
    <title>الشاشات الرئيسية — هيلني شوب</title>
    <meta charset="UTF-8">
...
<body>
    <div class="shell">
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-title">الشاشات الرئيسية</div>
            ...
            <div class="content">
                ...
                <div class="page-header-row">
                    ...
                    <a href="#" class="btn-red"><i class="ti ti-plus" aria-hidden="true"></i> شاشة جديدة</a>
                </div>
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-label">إجمالي الشاشات</div>
                        <div class="stat-val">5</div><i class="ti ti-device-tv stat-icon" aria-hidden="true"></i>
                    </div>
                    <div class="stat-card" style="--accent:#27AE60">
                        <div class="stat-label">نشطة</div>
                        <div class="stat-val" style="color:#27AE60">4</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-label">معطلة</div>
                        <div class="stat-val" style="color:var(--red-light)">1</div>
                    </div>
                    <div class="stat-card" style="--accent:#2980B9">
                        <div class="stat-label">متوسط المدة</div>
                        <div class="stat-val">22ث</div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-hd">
                        ...
                        <div class="input-wrap"><i class="ti ti-search search-icon" aria-hidden="true"></i><input
                                class="search-inp" id="scrSearch" placeholder="بحث..."></div>
                    </div>
                    <table id="scrTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="color:var(--text3);font-size:11px">main_screen_1.jpg</td>
                                <td>10</td>
                            ...
                            <tr>
                                ...
                                <td style="color:var(--text3);font-size:11px">welcome.mp4</td>
                                <td>45</td>
                                <td><span class="tag tag-g">نشط</span></td>
                                <td><button class="topbar-btn" style="margin-left:4px" aria-label="تعديل"><i
                                            class="ti ti-edit" aria-hidden="true"></i></button><button
                            ...
                            <tr>
                                <td style="color:var(--text);font-weight:500">شاشة العروض</td>
                                <td><span class="tag"
                                        style="background:rgba(41,128,185,.15);color:#2980B9">صورة</span></td>
                                <td style="color:var(--text3);font-size:11px">offers.jpg</td>
                                <td>15</td>
                                <td><span class="tag tag-g">نشط</span></td>
                                <td><button class="topbar-btn" style="margin-left:4px" aria-label="تعديل"><i
                                            class="ti ti-edit" aria-hidden="true"></i></button><button
                            ...
                            <tr>
                                <td style="color:var(--text);font-weight:500">شاشة يوتيوب</td>
                                <td><span class="tag"
                                        style="background:rgba(192,57,43,.15);color:var(--red-light)">يوتيوب</span>
                                </td>
                                <td style="color:var(--text3);font-size:11px">youtube.com/watch?v=xxx</td>
                                <td>30</td>
                                <td><span class="tag tag-r">معطل</span></td>
                                <td><button class="topbar-btn" style="margin-left:4px" aria-label="تعديل"><i
                                            class="ti ti-edit" aria-hidden="true"></i></button><button
                                        class="topbar-btn" aria-label="حذف"><i class="ti ti-trash"
                                            aria-hidden="true"></i></button></td>
    ...
    <script>
        document.getElementById('scrSearch').addEventListener('input', function() {
            const q = this.value.toLowerCase();
            document.querySelectorAll('#scrTable tbody tr').forEach(r => {
