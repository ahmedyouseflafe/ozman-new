...
<head>
    <title>الرئيسية — هيلني شوب</title>
    <meta charset="UTF-8">
...
<body>
    <div class="shell">
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-title">الرئيسية</div>
            ...
            <div class="content">
                ...
                <div class="grid2">
                    ...
                    <div class="card">
                        <div class="card-hd">
                            <h3>آخر المنتجات المضافة</h3><a href="products.html" class="btn-red"><i
                                    class="ti ti-plus" aria-hidden="true"></i> إضافة</a>
                        </div>
