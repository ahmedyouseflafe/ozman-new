                    ...
                    <section class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full">
                                ...
                                <small style="color:rgba(255,255,255,.55)">يحدد الحقول التي ستظهر لصاحب المتجر عند إدارة الفئات والمنتجات. عند اختيار «خدمات دعائية وطباعة» تُنشأ أقسام الطباعة والخدمات تلقائيًا.</small>
                            </div>
