...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .leaflet-container,
        .leaflet-control { font-family: 'Cairo', sans-serif; }
...
<body>
    @php
        $shop = $shop ?? (object) [
            ...
            'name' => 'Ozman Shop',
            'slug' => 'ozman-shop',
            'description' => 'متجر تجريبي لإدارة بيانات صفحة التعديل.',
            'phone' => '059-000-0001',
            'whatsapp' => '059-000-0001',
            'email' => 'shop@ozman.com',
            'city' => 'غزة',
            'country' => 'فلسطين',
    ...
    <div class="shell">
        ...
        <main class="main">
            @include('admin.includes.header', ['title' => 'تعديل متجر'])

            <div class="content">
                <section class="hero-strip" aria-label="شريط تعديل متجر">
                    <div class="ticker">
                        <span>تعديل بيانات {{ $shopName }}</span>
                        <span>حدّث المعلومات، الموقع، الصور، وحالة الظهور من نفس الصفحة</span>
                ...
                <header class="page-head">
                    <div>
                        ...
                        <h1>تعديل متجر</h1>
                        <p>تحديث بيانات {{ $shopName }} ومعلومات التواصل والموقع والظهور داخل المنصة.</p>
                    </div>
                ...
                <form class="form-shell" action="{{ route('shops.update', $shopId) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <section class="form-section">
                        <div class="section-head">
                            ...
                            <div>
                                ...
                                <p>عدّل الاسم والوصف والرابط المختصر الخاص بالمتجر.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="name" name="name" value="{{ old('name', data_get($shop, 'name')) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="slug" name="slug" value="{{ old('slug', data_get($shop, 'slug')) }}" dir="ltr">
                        ...
                        <section class="form-section">
                            <div class="section-head">
                                ...
                                <div>
                                    ...
                                    <p>اترك كلمة المرور فارغة إذا لم ترغب بتغييرها.</p>
                                </div>
                            </div>
                            ...
                            <div class="form-grid">
                                <div class="form-group full">
                                    ...
                                    <div class="field">
                                        <input type="email" id="owner_email" name="owner_email" value="{{ old('owner_email', optional($shop->user)->email) }}" dir="ltr">
                    ...
                    <section class="form-section">
                        <div class="section-head">
                            ...
                            <div>
                                ...
                                <p>حدّث أرقام التواصل والبريد الإلكتروني الخاص بالمتجر.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="phone" name="phone" value="{{ old('phone', data_get($shop, 'phone')) }}" dir="ltr">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="whatsapp" name="whatsapp" value="{{ old('whatsapp', data_get($shop, 'whatsapp')) }}" dir="ltr">
                            ...
                            <div class="form-group full">
                                ...
                                <div class="field">
                                    <input type="email" id="email" name="email" value="{{ old('email', data_get($shop, 'email')) }}" dir="ltr">
                                    <i class="ti ti-mail field-icon" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="form-section">
                        <div class="section-head">
                            ...
                            <div>
                                ...
                                <p>عدّل العنوان وساعات الدوام وموقع المتجر على الخريطة.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="city" name="city" value="{{ old('city', data_get($shop, 'city')) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="country" name="country" value="{{ old('country', data_get($shop, 'country')) }}">
                            ...
                            <div class="form-group full">
                                ...
                                <div class="field">
                                    <input type="text" id="address" name="address" value="{{ old('address', data_get($shop, 'address')) }}">
                            ...
                            <div class="form-group full">
                                <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', data_get($shop, 'latitude')) }}">
                                <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', data_get($shop, 'longitude')) }}">
                                    ...
                                    <div class="card-copy">
                                        ...
                                        <span>
                                            ...
                                            <span class="card-sub" id="locationSummary">
                                                @if(old('latitude', data_get($shop, 'latitude')) && old('longitude', data_get($shop, 'longitude')))
                                                    تم اختيار الموقع: <span class="map-status">{{ old('latitude', data_get($shop, 'latitude')) }}, {{ old('longitude', data_get($shop, 'longitude')) }}</span>
                                                @else
    ...
    <div class="section-head">
        ...
        <div>
            ...
            <p>تعديل روابط صفحات المتجر على السوشال ميديا.</p>
        </div>
    </div>
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="facebook"
                    value="{{ old('facebook', optional($shop->social)->facebook) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="instagram"
                    value="{{ old('instagram', optional($shop->social)->instagram) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="tiktok"
                    value="{{ old('tiktok', optional($shop->social)->tiktok) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="telegram"
                    value="{{ old('telegram', optional($shop->social)->telegram) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="snapchat"
                    value="{{ old('snapchat', optional($shop->social)->snapchat) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="twitter"
                    value="{{ old('twitter', optional($shop->social)->twitter) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    name="youtube"
                    value="{{ old('youtube', optional($shop->social)->youtube) }}"
        ...
        <div class="form-group">
            ...
            <div class="field">
                <input type="text"
                    ...
                    value="{{ old('social_whatsapp', optional($shop->social)->whatsapp) }}"
                ...
                <i class="ti ti-brand-whatsapp field-icon"></i>
                    ...
                    <section class="form-section">
                        <div class="section-head">
                            ...
                            <div>
                                <h2>معلومات الدفع</h2>
                                <p>تحديث بيانات الحساب الذي يستقبل دفعات العملاء الخاصة بهذا المتجر.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <select id="payment_method" name="payment_method">
                                        ...
                                        <option value="bank_transfer" @selected(old('payment_method', data_get($shop, 'payment_method')) === 'bank_transfer')>تحويل بنكي</option>
                                        <option value="wallet" @selected(old('payment_method', data_get($shop, 'payment_method')) === 'wallet')>محفظة إلكترونية</option>
                                        <option value="cash" @selected(old('payment_method', data_get($shop, 'payment_method')) === 'cash')>كاش / عند الاستلام</option>
                                        <option value="other" @selected(old('payment_method', data_get($shop, 'payment_method')) === 'other')>أخرى</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="payment_provider" name="payment_provider" value="{{ old('payment_provider', data_get($shop, 'payment_provider')) }}" placeholder="اسم البنك أو المحفظة">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="payment_account_holder" name="payment_account_holder" value="{{ old('payment_account_holder', data_get($shop, 'payment_account_holder')) }}" placeholder="الاسم كما يظهر في الحساب">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="payment_account_number" name="payment_account_number" value="{{ old('payment_account_number', data_get($shop, 'payment_account_number')) }}" dir="ltr" placeholder="Account number">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="payment_iban" name="payment_iban" value="{{ old('payment_iban', data_get($shop, 'payment_iban')) }}" dir="ltr" placeholder="IBAN">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" id="payment_wallet_number" name="payment_wallet_number" value="{{ old('payment_wallet_number', data_get($shop, 'payment_wallet_number')) }}" dir="ltr" placeholder="+970599999999">
                            ...
                            <div class="form-group full">
                                ...
                                <div class="field">
                                    <textarea id="payment_notes" name="payment_notes" placeholder="أي تعليمات إضافية للدفع أو التحويل">{{ old('payment_notes', data_get($shop, 'payment_notes')) }}</textarea>
                                    <i class="ti ti-notes field-icon" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="form-section">
                        <div class="section-head">
                            ...
                            <div>
                                <h2>الصور والحالة</h2>
                                <p>استبدل الشعار أو البانر وعدّل حالة ظهور المتجر.</p>
                            </div>
                        </div>
                        ...
                        <div class="upload-grid">
                            <label class="upload-box">
                                ...
                                <span class="card-icon"><i class="ti ti-badge" aria-hidden="true"></i></span>
                                <span>
                                    <span class="upload-title">شعار المتجر</span>
                                    <span class="upload-sub">{{ data_get($shop, 'logo') ? 'الشعار الحالي محفوظ، اختر ملفا لاستبداله' : 'لا يوجد شعار حالي، اختر صورة جديدة' }}</span>
                                </span>
                            </label>

                            <label class="upload-box">
                                <input type="file" name="banner" accept="image/*">
                                <span class="card-icon"><i class="ti ti-photo" aria-hidden="true"></i></span>
                                <span>
                                    <span class="upload-title">بانر المتجر</span>
                                    <span class="upload-sub">{{ data_get($shop, 'banner') ? 'البانر الحالي محفوظ، اختر ملفا لاستبداله' : 'لا يوجد بانر حالي، اختر صورة جديدة' }}</span>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="switch-card">
                            <div class="card-copy">
                                ...
                                <span>
                                    ...
                                    <span class="card-sub">المتجر النشط يظهر داخل المنصة للمستخدمين.</span>
                                </span>
                            </div>
        ...
        <div class="location-modal" role="dialog" aria-modal="true" aria-labelledby="locationModalTitle">
            <div class="modal-head">
                <div class="modal-title">
                    ...
                    <span>
                        <strong id="locationModalTitle">تعديل موقع المتجر</strong>
