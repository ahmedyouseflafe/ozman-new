<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    input[type="number"], input[type="url"] { direction:ltr; text-align:left; }
    ...
    .current-media, .detail-box { border:1px solid var(--border); border-radius:18px; background:rgba(0,0,0,.22); padding:14px; }
    ...
    .preview { width:100%; max-height:380px; border-radius:22px; border:1px solid var(--border); background:#000; object-fit:contain; }
