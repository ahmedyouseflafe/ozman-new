...
<head>
    <title>الإعلانات — هيلني شوب</title>
    <meta charset="UTF-8">
...
<body>
    <div class="shell">
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-title">الإعلانات</div>
            ...
            <div class="content">
                ...
                <div class="page-header-row">
                    ...
                    <a href="#" class="btn-red"><i class="ti ti-plus" aria-hidden="true"></i> إعلان جديد</a>
                </div>
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-label">إجمالي الإعلانات</div>
                        <div class="stat-val">9</div><i class="ti ti-speakerphone stat-icon" aria-hidden="true"></i>
                    </div>
                    <div class="stat-card" style="--accent:#2980B9">
                        <div class="stat-label">صور</div>
                        <div class="stat-val" style="color:#2980B9">4</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-label">فيديوهات</div>
                        <div class="stat-val" style="color:var(--red-light)">3</div>
                    </div>
                    <div class="stat-card" style="--accent:var(--gold)">
                        <div class="stat-label">يوتيوب</div>
                        <div class="stat-val" style="color:var(--gold)">2</div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-hd">
                        ...
                        <div class="filter-row">
                            ...
                            <div class="input-wrap"><i class="ti ti-search search-icon" aria-hidden="true"></i><input
                                    class="search-inp" id="adSearch" placeholder="بحث..."></div>
                        </div>
                    </div>
                    <table id="adsTable">
                        <thead>
                        ...
                        <tbody>
                            <tr data-type="صورة">
                                ...
                                <td style="color:var(--text3);font-size:11px">خصم 20% على كل المنتجات</td>
                                <td><span class="tag"
                            ...
                            <tr data-type="فيديو">
                                ...
                                <td style="color:var(--text3);font-size:11px">إعلان الإطلاق الرسمي</td>
                                <td><span class="tag"
                            ...
                            <tr data-type="يوتيوب">
                                ...
                                <td style="color:var(--text3);font-size:11px">تعريف بالمنتجات الجديدة</td>
                                <td><span class="tag"
                            ...
                            <tr data-type="صورة">
                                <td style="color:var(--text);font-weight:500">إعلان العناية بالبشرة</td>
                                <td style="color:var(--text3);font-size:11px">منتجات Cliven الجديدة</td>
                                <td><span class="tag"
                                        style="background:rgba(41,128,185,.15);color:#2980B9">صورة</span></td>
    ...
    <script>
        function filterAds() {
            ...
            const t = document.getElementById('adTypeFilter').value;
            document.querySelectorAll('#adsTable tbody tr').forEach(r => {
                const mq = r.textContent.toLowerCase().includes(q);
                const mt = !t || r.dataset.type === t;
                r.style.display = (mq && mt) ? '' : 'none';
            });
        }
