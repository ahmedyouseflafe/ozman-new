...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .restaurant-page{width:min(1480px,calc(100% - 48px));margin-right:280px;padding:34px 0 60px}
        ...
        .hero{position:relative;overflow:hidden;border-radius:28px;padding:30px 34px;margin-bottom:22px}
        ...
        .eyebrow{color:var(--cyan);font-weight:800;font-size:13px}.hero h1{font-size:clamp(25px,3vw,42px);line-height:1.35;margin:8px 0}.hero p{color:var(--muted);margin:0;max-width:750px;font-weight:600}
        ...
        .stat{position:relative;overflow:hidden;border-radius:22px;padding:21px 22px;min-height:130px}
        ...
        .stat-icon{width:44px;height:44px;border-radius:14px;display:grid;place-items:center;background:color-mix(in srgb,var(--accent) 14%,transparent);color:var(--accent);font-size:24px}.stat-label{color:#c3cad2;font-weight:700}.stat strong{display:block;color:var(--accent);font-size:35px;margin-top:6px;line-height:1}
        .section{border-radius:27px;padding:26px;margin-bottom:22px}.section-head{margin-bottom:20px}.section-title{display:flex;align-items:center;gap:12px}.section-icon{width:48px;height:48px;border-radius:15px;display:grid;place-items:center;border:1px solid rgba(8,220,244,.32);background:var(--cyan-soft);color:var(--cyan);font-size:25px}.section h2{font-size:24px;margin:0}.section-subtitle{color:var(--muted);font-size:13px;margin-top:3px}
        ...
        .tables-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(225px,1fr));gap:15px;margin-top:20px}.table-card{border:1px solid var(--border);background:rgba(5,8,13,.72);border-radius:19px;padding:17px;text-align:center}.table-card h3{margin:4px 0}.table-card p{color:var(--muted);margin:3px}.qr-box{width:138px;height:138px;padding:8px;background:#fff;border-radius:15px;margin:13px auto}.qr-box img{width:100%;height:100%}.table-actions{display:flex;justify-content:center;gap:8px;flex-wrap:wrap}
        ...
        .notice{border-radius:16px;padding:14px 18px;margin-bottom:18px}.notice-success{border:1px solid rgba(37,223,135,.35);background:rgba(37,223,135,.09);color:#73f2ae}.notice-error{border:1px solid rgba(255,98,116,.35);background:rgba(255,98,116,.09);color:#ffabb5}.empty{color:var(--muted);text-align:center;padding:26px}
        nav[role="navigation"]{margin-top:18px}
        @media(max-width:1250px){.restaurant-page{width:calc(100% - 290px);margin-right:270px}.stats-grid{grid-template-columns:repeat(2,1fr)}}
