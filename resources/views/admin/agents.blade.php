...
<body>
    <div class="shell">
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-title">الوكلاء</div>
            ...
            <div class="content">
                ...
                <div class="page-header-row">
                    ...
                    <a href="#" class="btn-red"><i class="ti ti-plus" aria-hidden="true"></i> وكيل جديد</a>
                </div>
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-label">إجمالي الوكلاء</div>
                        <div class="stat-val">18</div><i class="ti ti-user-check stat-icon" aria-hidden="true"></i>
                    </div>
                    <div class="stat-card" style="--accent:#27AE60">
                        <div class="stat-label">نشط</div>
                        <div class="stat-val" style="color:#27AE60">15</div>
                    </div>
                    <div class="stat-card">
                ...
                <div class="card">
                    <div class="card-hd">
                        ...
                        <div class="input-wrap"><i class="ti ti-search search-icon" aria-hidden="true"></i><input
                                class="search-inp" id="agentSearch" placeholder="بحث..."></div>
                    </div>
                    <table id="agentsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="color:var(--text);font-weight:500">ليلى عمر</td>
                                <td dir="ltr">059-400-5000</td>
                                <td dir="ltr">059-400-5000</td>
    ...
    <script>
        document.getElementById('agentSearch').addEventListener('input', function() {
            ...
            document.querySelectorAll('#agentsTable tbody tr').forEach(r => {
