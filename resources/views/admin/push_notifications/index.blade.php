...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;background:#061012;color:#fff;font-family:Cairo,sans-serif}.shell{min-height:100vh}.main{margin-right:245px;min-height:100vh}.content{padding:32px;max-width:980px;margin:auto}.card{background:rgba(8,25,28,.92);border:1px solid rgba(0,229,255,.2);border-radius:24px;padding:26px;box-shadow:0 18px 55px rgba(0,0,0,.25)}h1{margin:0 0 8px}.muted{color:#9fb4b7}.stats{display:flex;gap:12px;margin:22px 0}.stat{padding:12px 18px;border-radius:14px;background:rgba(0,229,255,.08);color:#00e5ff;font-weight:800}.notice,.success,.error{padding:14px 16px;border-radius:14px;margin:16px 0}.notice{background:#33280b;color:#ffd86b}.success{background:#0c3929;color:#7fffc5}.error{background:#42181d;color:#ff9da7}label{display:block;font-weight:800;margin:18px 0 7px}input,textarea{width:100%;padding:14px;border-radius:13px;border:1px solid rgba(255,255,255,.16);background:#071416;color:#fff;font:inherit}textarea{min-height:125px;resize:vertical}button{margin-top:22px;padding:14px 25px;border:0;border-radius:14px;background:#00e5ff;color:#001012;font:800 15px Cairo;cursor:pointer}button:disabled{opacity:.45;cursor:not-allowed}@media(max-width:900px){.main{margin-right:0}.content{padding:20px 14px 110px}}
    </style>
</head>
<body>
<div class="shell">
