...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .section-icon, .card-icon { width:46px; height:46px; border-radius:16px; background:#000; border:1px solid var(--primary); color:var(--primary); display:grid; place-items:center; font-size:21px; box-shadow:0 0 18px rgba(0,229,255,.28); }
    ...
    <div class="shell">
        ...
        <main class="main">
            ...
            <div class="content">
                ...
                <form class="form-shell" action="{{ route('categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
