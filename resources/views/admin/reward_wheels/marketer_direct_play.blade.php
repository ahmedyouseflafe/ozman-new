...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .wheel-prize-image { position:absolute; top:50%; left:50%; width:58px; height:58px; object-fit:cover; border-radius:16px; border:2px solid rgba(255,255,255,.72); background:#050505; box-shadow:0 6px 18px rgba(0,0,0,.32); transform-origin:0 0; z-index:1; }
        ...
        @media(max-width:900px){ .main{margin-right:0}.content{padding:22px 16px 36px}.play-head{flex-direction:column;align-items:stretch} h1{font-size:28px}.wheel{width:min(84vw,370px)} }
    </style>
</head>
